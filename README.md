...
A C++ prototype for an (audio) fingerprinting algorithm that combines **digital signal processing (DSP)** with **data structures & algorithms (DSA)** to identify/match a query against a small library of tracks.
